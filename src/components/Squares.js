...
export default function Squares() {
  ...
  // 'activeSquare'. One holds the _array_ of square ids, and the other keeps track of the currently active square. On page load there's no active square, so the value of 'activeSquare' should be null.
  ...
  const getClassName = id => {
    ...
    // It should return a string containing the class name of 'active', if the id passed as the argument matches the active square in state, empty string otherwise. Right-click and "inspect element" on the square to see its effect.
